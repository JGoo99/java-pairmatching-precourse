...
- 페어 프로그래밍: 미션을 수행하며 각 레벨에서 전달하고자 하는 내용을 학습
...
- [x]  크루 목록의 순서를 랜덤으로 섞는다. 이 때 `camp.nextstep.edu.missionutils.Randoms`의 2 메서드를 활용해야 한다.
